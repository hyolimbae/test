...
{
	IMAGEMANAGER->addImage("¾ð´öÀÌ¹ÌÁö", "mountain.bmp", WINSIZEX, WINSIZEY, true, RGB(255, 0, 255));
...
void pixelCollision::update()
{
	...
	{
		COLORREF color = GetPixel(IMAGEMANAGER->findImage("¾ð´öÀÌ¹ÌÁö")->getMemDC(), _x, i);
...
{
	IMAGEMANAGER->findImage("¾ð´öÀÌ¹ÌÁö")->render(getMemDC(), 0, 0);
